...
export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <h1 className="text-3xl tracking-tight font-bold text-neutral-300 mb-8">Gizlilik Politikası</h1>
      ...
      <div className="prose prose-invert prose-mystic max-w-none space-y-6 text-night-200">
        ...
        <section>
          <h2 className="tracking-tight text-xl font-bold text-mystic-400 mt-8 mb-4">2. Log Dosyaları</h2>
          <p>
        ...
        <section>
          <h2 className="tracking-tight text-xl font-bold text-mystic-400 mt-8 mb-4">3. Çerezler (Cookies) ve Web İşaretçileri</h2>
          <p>
        ...
        <section>
          <h2 className="tracking-tight text-xl font-bold text-mystic-400 mt-8 mb-4">4. Reklam Ortakları ve Üçüncü Taraf Çerezleri</h2>
          <p>
        ...
        <section>
          <h2 className="tracking-tight text-xl font-bold text-mystic-400 mt-8 mb-4">5. Analitik Araçları</h2>
          <p>
        ...
        <section>
          <h2 className="tracking-tight text-xl font-bold text-mystic-400 mt-8 mb-4">6. İletişim</h2>
          <p>
