...
// Generate exactly 1000 distinct items (25 * 40 = 1000)
const adjectives = [
  "Sonsuz", "Görünmez", "Kaybolan", "Parıldayan", "Yasak", 
  "Zehirli", "Yaralı", "Cennet", "Cehennem", "Kayıp",
  "Gizli", "Ölümsüz", "Mistik", "Korkunç", "Devasa", 
  "Şeffaf", "Zaman", "Hayalet", "Kadim", "Yüce",
  "Ağır", "Hafif", "Saydam", "Külden", "Kanlı"
];

const nouns = [
  { name: "Şahin", cat: "hayvanlar" },
  { name: "Baykuş", cat: "hayvanlar" },
  { name: "Timsah", cat: "hayvanlar" },
  { name: "Ayı", cat: "hayvanlar" },
  { name: "Kurt", cat: "hayvanlar" },
  { name: "Tilki", cat: "hayvanlar" },
  { name: "Panter", cat: "hayvanlar" },
  { name: "Goril", cat: "hayvanlar" },
  { name: "İguana", cat: "hayvanlar" },
  { name: "Yarasa", cat: "hayvanlar" },

  { name: "Yanardağ", cat: "doga" },
  { name: "Nehir", cat: "doga" },
  { name: "Kanyon", cat: "doga" },
  { name: "Toprak", cat: "doga" },
  { name: "Gökyüzü", cat: "doga" },
  { name: "Yeraltı", cat: "doga" },
  { name: "Yıldırım", cat: "doga" },
  { name: "Şimşek", cat: "doga" },
  { name: "Bataklık", cat: "doga" },
  { name: "Çayır", cat: "doga" },

  { name: "Kule", cat: "mekanlar" },
  { name: "Labirent", cat: "mekanlar" },
  { name: "Zindan", cat: "mekanlar" },
  { name: "Tapınak", cat: "mekanlar" },
  { name: "Saray", cat: "mekanlar" },
  { name: "Liman", cat: "mekanlar" },
  { name: "Cadde", cat: "mekanlar" },
  { name: "Tünel", cat: "mekanlar" },
  { name: "Köşk", cat: "mekanlar" },
  { name: "Han", cat: "mekanlar" },

  { name: "Helikopter", cat: "yolculuk" },
  { name: "Vapur", cat: "yolculuk" },
  { name: "Motor", cat: "yolculuk" },
  { name: "Taksi", cat: "yolculuk" },
  { name: "Tramvay", cat: "yolculuk" },

  { name: "Kılıç", cat: "nesneler" },
  { name: "Hazine", cat: "nesneler" },
  { name: "Elmas", cat: "nesneler" },
  { name: "Kalkan", cat: "nesneler" },
  { name: "Zırh", cat: "nesneler" }
];
...
const filePath = path.join(symbolsBaseDir, 'batch-1000.json');
...
console.log(`Successfully generated ${generatedList.length} new symbols in content/symbols/batch-1000.json!`);
