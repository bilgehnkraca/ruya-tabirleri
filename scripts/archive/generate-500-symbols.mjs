...
// Generate exactly 500 distinct items (20 * 25 = 500)
const adjectives = [
  "Efsanevi", "Sihirli", "Ağlayan", "Gülen", "Kanatlı", 
  "Ateşli", "Buzlu", "Saklı", "Öfkeli", "Durgun", 
  "Deli", "Vahşi", "Sakin", "Zengin", "Yoksul", 
  "Hasta", "Mutlu", "Cesur", "Üzgün", "Hızlı"
];

const nouns = [
  { name: "Kaplan", cat: "hayvanlar" },
  { name: "Akrep", cat: "hayvanlar" },
  { name: "Örümcek", cat: "hayvanlar" },
  { name: "Yılan", cat: "hayvanlar" },
  { name: "Fare", cat: "hayvanlar" },
  { name: "Maymun", cat: "hayvanlar" },
  { name: "Köpekbalığı", cat: "hayvanlar" },
  { name: "Orman", cat: "doga" },
  { name: "Dağ", cat: "doga" },
  { name: "Vadi", cat: "doga" },
  { name: "Çöl", cat: "doga" },
  { name: "Rüzgar", cat: "doga" },
  { name: "Fırtına", cat: "doga" },
  { name: "Bulut", cat: "doga" },
  { name: "Ay", cat: "nesneler" },
  { name: "Güneş", cat: "nesneler" },
  { name: "Kalkan", cat: "nesneler" },
  { name: "Yatak", cat: "nesneler" },
  { name: "Dolap", cat: "nesneler" },
  { name: "Tablo", cat: "nesneler" },
  { name: "Heykel", cat: "nesneler" },
  { name: "Halı", cat: "nesneler" },
  { name: "Gemi", cat: "yolculuk" },
  { name: "Kervan", cat: "yolculuk" },
  { name: "Bisiklet", cat: "yolculuk" }
];
...
const filePath = path.join(symbolsBaseDir, 'batch-500.json');
...
console.log(`Successfully generated ${generatedList.length} new symbols in content/symbols/batch-500.json!`);
