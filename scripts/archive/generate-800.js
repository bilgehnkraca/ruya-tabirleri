...
const batches = {
  'complex-symbols-2026-batch-14.json': [
    { slug: 'annemin-bana-beyaz-ceyiz-sandigi-hediye-etmesi', title: 'Rüyada Annenin Bana Beyaz Çeyiz Sandığı Hediye Etmesi', category: 'ailem' },
    { slug: 'babanin-yeni-ve-buyuk-bir-ev-satinaldigini-gormek', title: 'Rüyada Babanın Yeni ve Büyük Bir Ev Satın Aldığını Görmek', category: 'ailem' },
    { slug: 'kardesinle-birlikte-yemyesil-bahcede-agac-dikmek', title: 'Rüyada Kardeşinle Birlikte Yemyeşil Bahçede Fidan ve Ağaç Dikmek', category: 'ailem' },
    { slug: 'vefat-eden-dedenin-sana-altin-saat-vermesi', title: 'Rüyada Vefat Eden Dedenin Sana Parlak Altın Saat Vermesi', category: 'ailem' },
    { slug: 'anneannenin-mutfakta-sicak-corba-kaynattigini-gormek', title: 'Rüyada Anneannenin Mutfakta Şifalı ve Sıcak Çorba Kaynatması', category: 'ailem' },
    { slug: 'babaannenin-basina-beyaz-yemeni-bagladigini-gormek', title: 'Rüyada Babaannenin Başına Bembeyaz İpek Yemeni Bağlaması', category: 'ailem' },
    { slug: 'kiz-kardesinin-basarisini-kutlayip-sarilmak', title: 'Rüyada Kız Kardeşinin Büyük Başarısını Kutlayıp Sevinçle Sarılmak', category: 'ailem' },
    { slug: 'erkek-kardesinle-yeni-bir-is-kurdugunu-gormek', title: 'Rüyada Erkek Kardeşinle Birlikte Hayırlı ve Yeni Bir İş Kurmak', category: 'ailem' },
    { slug: 'babanin-omzuna-dokunup-sana-destek-oldugunu-soylemesi', title: 'Rüyada Babanın Omzuna Dokunup Sana Her Zaman Destek Olduğunu Söylemesi', category: 'ailem' },
    { slug: 'vefat-eden-annenin-evde-cicekleri-duzenlemesi', title: 'Rüyada Vefat Eden Annenin Evde Saksı Çiçeklerini Düzenlemesi', category: 'ailem' },
    { slug: 'tanimadigin-sevimli-bir-cocugun-sana-cicek-vermesi', title: 'Rüyada Tanımadığın Sevimli Bir Çocuğun Sana Kırmızı Gül ve Çiçek Vermesi', category: 'insanlar' },
    { slug: 'eski-is-arkadasinla-yeni-ve-modern-ofiste-karsilasmak', title: 'Rüyada Eski İş Arkadaşınla Yeni ve Modern Bir Ofiste Karşılaşmak', category: 'insanlar' },
    { slug: 'kalabalik-ve-neseli-festivalde-insanlarla-dans-etmek', title: 'Rüyada Kalabalık ve Neşeli Bir Festivalde İnsanlarla Müzik Eşliğinde Dans Etmek', category: 'insanlar' },
    { slug: 'okul-yillarindan-eski-dostunla-kahve-icmek', title: 'Rüyada Okul Yıllarından Eski Bir Dostunla Deniz Kenarında Kahve İçmek', category: 'insanlar' },
    { slug: 'evine-gelen-misafirlerin-ayakkabilarinin-kapida-dizilmesi', title: 'Rüyada Evine Gelen Kalabalık Misafirlerin Ayakkabılarının Kapıda Düzgünce Dizilmesi', category: 'insanlar' },
    { slug: 'hastanedeki-yakininin-iyilesip-eve-dondugunu-gormek', title: 'Rüyada Hastanedeki Bir Yakınının Tamamen İyileşip Mutlulukla Eve Dönmesi', category: 'insanlar' },
    { slug: 'gelinlik-giyen-tanidiginin-bana-gulumseyerek-bakmasi', title: 'Rüyada Gelinlik Giyen Bir Tanıdığının Bana Gülümseyerek Bakması', category: 'insanlar' },
    { slug: 'tanimadigin-nurani-yasli-kadinin-sana-dua-etmesi', title: 'Rüyada Tanımadığın Nurani Yaşlı Bir Kadının Sana İçtenlikle Dua Etmesi', category: 'insanlar' },
    { slug: 'komsuyla-balkondan-balkona-guzel-sohbet-etmek', title: 'Rüyada Sevdiğin Komşuyla Balkondan Balkona Neşeyle Sohbet Etmek', category: 'insanlar' },
    { slug: 'dugun-salonunda-gelin-ve-damadin-mutlu-oyununu-izlemek', title: 'Rüyada Düğün Salonunda Gelin ve Damadın Mutlu Oyununu İzlemek', category: 'insanlar' },
    { slug: 'patronunun-sana-takkir-ve-basari-belgesi-vermesi', title: 'Rüyada Patronunun Sana Takdir ve Başarı Belgesi Takdim Etmesi', category: 'insanlar' },
    { slug: 'sokakta-yururken-insanlarin-sana-gulumseyip-selam-vermesi', title: 'Rüyada Sokakta Yürürken İnsanların Sana Saygıyla Gülümseyip Selam Vermesi', category: 'insanlar' },
    { slug: 'eski-dostunun-kapina-gelip-seni-ne-kadar-ozledigini-soylemesi', title: 'Rüyada Eski Bir Dostunun Kapına Gelip Seni Ne Kadar Özlediğini Söylemesi', category: 'insanlar' },
    { slug: 'uzaktan-gelen-sevdigin-birinin-sana-surpriz-yapmasi', title: 'Rüyada Uzaktan Gelen Sevdiğin Birinin Sana Büyük Sürpriz Yapması', category: 'insanlar' },
    { slug: 'kalabalik-ve-bereketli-iftar-sofrasinda-dua-beklemek', title: 'Rüyada Kalabalık ve Bereketli İftar Sofrasında Ezanı ve Duayı Beklemek', category: 'ailem' }
  ],
  'complex-symbols-2026-batch-15.json': [
    { slug: 'berrak-denizde-yuzen-altin-sarisi-baliklar-izlemek', title: 'Rüyada Berrak Denizde Yüzen Altın Sarısı Parlak Balıkları İzlemek', category: 'hayvanlar' },
    { slug: 'evcil-kopegin-bahcede-kuyruk-sallayip-oyun-oynamasi', title: 'Rüyada Evcil Bir Köpeğin Bahçede Neşeyle Kuyruk Sallayıp Oyun Oynaması', category: 'hayvanlar' },
    { slug: 'gokyuzunde-yuva-yapan-beyaz-leylekler-gormek', title: 'Rüyada Gökyüzünde Yüksek Bacaya Yuva Yapan Beyaz Leylekler Görmek', category: 'hayvanlar' },
    { slug: 'yemyesil-vadide-kosan-kizil-geyik-surusu-gormek', title: 'Rüyada Yemyeşil Vadide Özgürce Koşan Kızıl Geyik Sürüsü Görmek', category: 'hayvanlar' },
    { slug: 'beyaz-kugu-ciftinin-golette-zarifce-yuzmesi', title: 'Rüyada Beyaz Kuğu Çiftinin Sakin Gölette Zarifçe Yüzmesi', category: 'hayvanlar' },
    { slug: 'pencereye-konan-sari-kanarya-kusunun-otmesi', title: 'Rüyada Pencereye Konan Sarı Kanarya Kuşunun Tatlı Tatlı Ötmesi', category: 'hayvanlar' },
    { slug: 'yunus-baliklarinin-denizde-ziplayarak-yarismasi', title: 'Rüyada Yunus Balıklarının Berrak Denizde Zıplayarak Gösteri Yapması', category: 'hayvanlar' },
    { slug: 'ari-kovani-etrafinda-ucan-bal-arilari-gormek', title: 'Rüyada Arı Kovanı Etrafında Çalışkan ve Sakin Bal Arıları Görmek', category: 'hayvanlar' },
    { slug: 'karinca-yuvasindan-cikan-bereket-tanesini-izlemek', title: 'Rüyada Karınca Yuvasından Çıkan Buğday ve Bereket Tanelerini İzlemek', category: 'hayvanlar' },
    { slug: 'kelebeklerin-cicekli-bahcede-rengarenk-ucmasi', title: 'Rüyada Kelebeklerin Çiçekli Bahçede Rengarenk ve Özgürce Uçması', category: 'hayvanlar' },
    { slug: 'sabah-cigi-dusmus-yemyesil-cimenlerde-yurumek', title: 'Rüyada Sabah Çiği Düşmüş Yemyeşil Çimenlerde Yalınayak Yürümek', category: 'doga' },
    { slug: 'gunesin-bulutlarin-arasindan-altin-isiklarla-dogmasi', title: 'Rüyada Güneşin Bulutların Arasından Altın Işıklarla Göz Alıcı Doğması', category: 'doga' },
    { slug: 'yagmur-dinince-cikan-dev-gokkusaginin-altindan-gecmek', title: 'Rüyada Yağmur Dinince Çıkan Dev Gökkuşağının Altından Geçmek', category: 'doga' },
    { slug: 'gece-gokyuzunde-dolunay-ve-kutup-yildizini-izlemek', title: 'Rüyada Gece Gökyüzünde Parlayan Dolunay ve Kutup Yıldızını İzlemek', category: 'doga' },
    { slug: 'bahcedeki-yasemin-ve-lavanta-ciceklerini-koklamak', title: 'Rüyada Bahçedeki Mis Kokulu Yasemin ve Lavanta Çiçeklerini Koklamak', category: 'doga' },
    { slug: 'sakin-göl-kenarinda-oturup-su-yansimasini-izlemek', title: 'Rüyada Sakin Göl Kenarında Oturup Berrak Su Yansımasını İzlemek', category: 'doga' },
    { slug: 'karlarla-kapli-cam-ormani-icinde-yuruyus-yapmak', title: 'Rüyada Karlarla Kaplı Çam Ormanı İçinde Sessizce Yürüyüş Yapmak', category: 'doga' },
    { slug: 'ilkbaharda-cicek-acan-kiraz-agaclarinin-altinda-durmak', title: 'Rüyada İlkbaharda Çiçek Açan Pembe Kiraz Ağaçlarının Altında Durmak', category: 'doga' },
    { slug: 'ahsap-konagin-genis-ve-aydinlik-balkonunda-oturmak', title: 'Rüyada Ahşap Konağın Geniş ve Aydınlık Balkonunda Çay İçmek', category: 'mekanlar' },
    { slug: 'tarihi-tas-caminin-icinde-huzur-ve-ferahlik-hissetmek', title: 'Rüyada Tarihi Taş Caminin İçinde Muazzam Bir Huzur ve Ferahlık Hissetmek', category: 'mekanlar' },
    { slug: 'deniz-kenarindaki-beyaz-evde-pencereleri-acmak', title: 'Rüyada Deniz Kenarındaki Beyaz Evde Pencereleri Sonsuz Maviye Açmak', category: 'mekanlar' },
    { slug: 'eski-ve-restauro-edilmis-saray-avlusunda-yurumek', title: 'Rüyada Eski ve Restore Edilmiş Saray Avlusunda Şadırvanı İzlemek', category: 'mekanlar' },
    { slug: 'büyük-ve-duzenli-kitapcidaki-yeni-kitaplari-incelemek', title: 'Rüyada Büyük ve Düzenli Kitapçıda Yeni ve Değerli Kitapları İncelemek', category: 'mekanlar' },
    { slug: 'ferah-ve-gunes-alan-modern-ofiste-masasina-oturmak', title: 'Rüyada Ferah ve Güneş Alan Modern Ofiste Kendi Çalışma Masasına Oturmak', category: 'mekanlar' },
    { slug: 'luks-ve-konforlu-bir-otel-lobi-alaninda-dinlenmek', title: 'Rüyada Lüks ve Konforlu Bir Otelin Aydınlık Lobi Alanında Dinlenmek', category: 'mekanlar' }
  ],
  'complex-symbols-2026-batch-16.json': [
    { slug: 'yeni-aldigin-arabayla-dag-yolunda-manzara-izlemek', title: 'Rüyada Yeni Aldığın Arabayla Dağ Yolunda Güneşli Manzarayı İzlemek', category: 'yolculuk' },
    { slug: 'ucagin-camindan-asagidaki-masmavi-okyanusu-gormek', title: 'Rüyada Uçağın Camından Aşağıdaki Masmavi Okyanusu ve Adaları Görmek', category: 'yolculuk' },
    { slug: 'hizli-trenin-camindan-cicekli-ovalari-seyretmek', title: 'Rüyada Hızlı Trenin Camından Çiçekli Ovaları ve Köyleri Seyretmek', category: 'yolculuk' },
    { slug: 'beyaz-yolcu-gemisinin-güvertesinde-martilara-simit-atmak', title: 'Rüyada Beyaz Yolcu Gemisinin Güvertesinde Uçan Martılara Simit Atmak', category: 'yolculuk' },
    { slug: 'yeni-valiz-hazirlayip-hayalindeki-tatil-beldestine-gitmek', title: 'Rüyada Yeni Valiz Hazırlayıp Hayalindeki Tatil Beldesine Yolculuk Yapmak', category: 'yolculuk' },
    { slug: 'evin-camlarini-silip-pirtil-pirtil-parlattigini-gormek', title: 'Rüyada Evin Camlarını Silip Pırıl Pırıl Parlattığını Görmek', category: 'eylemler' },
    { slug: 'pazardan-aldigin-taze-meyveleri-yikaip-tabaga-koymak', title: 'Rüyada Pazardan Aldığın Taze Meyveleri Yıkayıp Kristal Tabağa Koymak', category: 'eylemler' },
    { slug: 'sicak-ekmek-firinindan-yeni-cikmis-pide-satinalmak', title: 'Rüyada Sıcak Ekmek Fırınından Yeni Çıkmış Susamlı Pide Satın Almak', category: 'eylemler' },
    { slug: 'ayna-karsisinda-yeni-aldigin-takim-elbiseyi-denemek', title: 'Rüyada Ayna Karşısında Yeni Aldığın Şık Takım Elbiseyi Denemek', category: 'eylemler' },
    { slug: 'bahcede-cicek-dikmek-icin-topragi-kazarken-su-bulmak', title: 'Rüyada Bahçede Çiçek Dikmek İçin Toprağı Kazarken Berrak Su Bulmak', category: 'eylemler' },
    { slug: 'sicak-yaz-gununde-agac-golgesinde-buzlu-limonata-icmek', title: 'Rüyada Sıcak Yaz Gününde Ağaç Gölgesinde Buzlu Limonata İçmek', category: 'eylemler' },
    { slug: 'aglayan-bir-bebegi-kucagina-alip-uyutmayi-basarmak', title: 'Rüyada Ağlayan Sevimli Bir Bebeği Kucağına Alıp Huzurla Uyutmak', category: 'eylemler' },
    { slug: 'yuksek-ve-manzarali-kopruden-yuruyerek-karsiya-gecmek', title: 'Rüyada Yüksek ve Manzaralı Köprüden Yürüyerek Güvenle Karşıya Geçmek', category: 'eylemler' },
    { slug: 'evin-odalarini-ferah-ve-aydinlik-renklere-boyamak', title: 'Rüyada Evin Odalarını Ferah ve Aydınlık Renklere Kendi Ellerinle Boyamak', category: 'eylemler' },
    { slug: 'kalabalik-ve-sik-bir-restoranda-lezzetli-aksam-yemegi-yemek', title: 'Rüyada Kalabalık ve Şık Bir Restoranda Lezzetli Akşam Yemeği Yemek', category: 'eylemler' },
    { slug: 'agactan-kendi-ellerinle-olgun-kirmizi-elma-toplamak', title: 'Rüyada Ağaçtan Kendi Ellerinle Olgun Kırmızı Elma ve Şeftali Toplamak', category: 'eylemler' },
    { slug: 'gece-gokyuzunde-parlayan-kuyruklu-yildizi-izlemek', title: 'Rüyada Gece Gökyüzünde Parlayan Kuyruklu Yıldızı Hayranlıkla İzlemek', category: 'eylemler' },
    { slug: 'eski-cuzdanindan-yeni-ve-gergin-kagit-paralar-cikarmak', title: 'Rüyada Eski Cüzdanından Yeni ve Gergin Kağıt Paralar Çıkarmak', category: 'eylemler' },
    { slug: 'topluluk-onunde-konusma-yapip-ayakta-alkislanmak', title: 'Rüyada Kalabalık Topluluk Önünde Başarılı Konuşma Yapıp Alkışlanmak', category: 'eylemler' },
    { slug: 'sokakta-buldugun-sevimli-kopege-su-ve-mama-vermek', title: 'Rüyada Sokakta Bulduğun Sevimli Köpeğe Su ve Mama Verip Sevmek', category: 'eylemler' },
    { slug: 'yagmur-altinda-semsiye-acmadan-yalinayak-kosmak', title: 'Rüyada Ilık Yağmur Altında Şemsiye Açmadan Yalınayak ve Özgürce Koşmak', category: 'eylemler' },
    { slug: 'bozuk-biri-saati-tamir-edip-zamanin-dogru-akmasini-saglamak', title: 'Rüyada Bozuk Bir Saati Tamir Edip Zamanın Doğru Akmasını Sağlamak', category: 'eylemler' },
    { slug: 'sandiktan-cikardigi-eski-altin-bilezikleri-koluna-takmak', title: 'Rüyada Sandıktan Çıkardığı Eski Altın Bilezikleri Koluna Takmak', category: 'eylemler' },
    { slug: 'yuksek-apartman-merdivenlerini-yorulmadan-hizla-cikmak', title: 'Rüyada Yüksek Apartman Merdivenlerini Yorulmadan Hızla Çıkmak', category: 'eylemler' },
    { slug: 'kalabalik-konser-alaninda-sevdigin-sarki-soylemek', title: 'Rüyada Kalabalık Konser Alanında Sevdiğin Şarkıyı Herkesle Söylemek', category: 'eylemler' }
  ],
  'complex-symbols-2026-batch-17.json': [
    { slug: 'parlak-gumus-tepside-kristal-bardaklar-ve-su-gormek', title: 'Rüyada Parlak Gümüş Tepside Kristal Bardaklar ve Berrak Su Görmek', category: 'nesneler' },
    { slug: 'eski-ahsap-duvar-saatinin-huzurlu-tik-tak-sesini-duymak', title: 'Rüyada Eski Ahşap Duvar Saatinin Huzurlu Tık Tak Sesini Duymak', category: 'nesneler' },
    { slug: 'penceredeki-beyaz-saten-perdenin-gunes-isigiyla-parlamasi', title: 'Rüyada Penceredeki Beyaz Saten Perdenin Güneş Işığıyla Parlaması', category: 'nesneler' },
    { slug: 'masanin-uzerinde-duran-altin-kaplama-kalem-ve-defter', title: 'Rüyada Masanın Üzerinde Duran Altın Kaplama Dolma Kalem ve Defter', category: 'nesneler' },
    { slug: 'kilitli-demir-kapiyi-elindeki-parlak-anahtarla-acmak', title: 'Rüyada Kilitli Demir Kapıyı Elindeki Parlak Anahtarla Kolayca Açmak', category: 'nesneler' },
    { slug: 'elindeki-parlak-makasla-altin-sarisi-kurdela-kesmek', title: 'Rüyada Elindeki Parlak Makasla Altın Sarısı Açılış Kurdelesi Kesmek', category: 'nesneler' },
    { slug: 'boynundaki-pirlanta-kolyenin-isikta-goz-kamastirmasi', title: 'Rüyada Boynundaki Pırlanta Kolyenin Işıkta Göz Kamaştırması', category: 'nesneler' },
    { slug: 'firin-tepsisinden-yeni-cikmis-cevizli-baklava-gormek', title: 'Rüyada Fırın Tepsisinden Yeni Çıkmış Çıtır ve Cevizli Baklava Görmek', category: 'yiyecek' },
    { slug: 'tabakta-duran-taze-ve-tatli-sari-incirleri-yemek', title: 'Rüyada Tabakta Duran Taze ve Tatlı Sarı İncirleri Afiyetle Yemek', category: 'yiyecek' },
    { slug: 'duman-ustunde-karanfilli-cay-ve-cikolata-ikram-etmek', title: 'Rüyada Dumanı Üstünde Karanfilli Çay ve Çikolata İkram Etmek', category: 'yiyecek' },
    { slug: 'taze-pismis-peynirli-pogaca-ve-zeytinle-kahvalti-yapmak', title: 'Rüyada Taze Pişmiş Peynirli Poğaça ve Zeytinle Zengin Kahvaltı Yapmak', category: 'yiyecek' },
    { slug: 'buyuk-dilim-fistikli-pasta-yiyip-sevdikleriyle-paylasmak', title: 'Rüyada Büyük Dilim Fıstıklı Yaş Pasta Yiyip Sevdikleriyle Paylaşmak', category: 'yiyecek' },
    { slug: 'kabede-kalabalik-cemaatle-birlikte-sabah-namazi-kilmak', title: 'Rüyada Kabe Avlusunda Kalabalık Cemaatle Birlikte Sabah Namazı Kılmak', category: 'soyut-kavramlar' },
    { slug: 'kuran-okuyan-huzurlu-bir-sesi-dinleyip-gozyasi-dokmek', title: 'Rüyada Kur\'an Okuyan Huzurlu Bir Sesi Dinleyip Şükür Gözyaşı Dökmek', category: 'soyut-kavramlar' },
    { slug: 'camide-dua-ederken-ellerinin-uzerine-isik-indigini-gormek', title: 'Rüyada Camide Dua Ederken Ellerinin Üzerine Nur Işığı İndiğini Görmek', category: 'soyut-kavramlar' },
    { slug: 'gokyuzunden-yagmur-gibi-yagan-beyaz-nur-tanesini-izlemek', title: 'Rüyada Gökyüzünden Yağmur Gibi Yağan Bembeyaz Nur Tanelerini İzlemek', category: 'soyut-kavramlar' },
    { slug: 'melek-gorunumlu-biriyle-gulumseyerek-el-sikismak', title: 'Rüyada Melek Görünümlü Aydınlık Biriyle Gülümseyerek El Sıkışmak', category: 'soyut-kavramlar' },
    { slug: 'sadaka-ve-zekat-verirken-yureginin-ferahladigini-gormek', title: 'Rüyada Sadaka ve Zekat Verirken Yüreğinin Muazzam Ferahladığını Görmek', category: 'soyut-kavramlar' },
    { slug: 'kutsal-topraklardan-gelen-ipek-seccadede-secdeye-varmak', title: 'Rüyada Kutsal Topraklardan Gelen İpek Seccadede Secdeye Varmak', category: 'soyut-kavramlar' },
    { slug: 'kadir-gecesinde-camide-sabaha-kadar-ibadet-edip-huzur-bulmak', title: 'Rüyada Kadir Gecesi\'nde Camide Sabaha Kadar İbadet Edip Huzur Bulmak', category: 'soyut-kavramlar' },
    { slug: 'aynada-yuzunun-parlak-aydinlik-ve-kusursuz-gorunmesi', title: 'Rüyada Aynada Yüzünün Parlak, Aydınlık ve Kusursuz Görünmesi', category: 'beden' },
    { slug: 'saclarinin-her-zamankinden-daha-gur-saglikli-uzamasi', title: 'Rüyada Saçlarının Her Zamankinden Daha Gür, Sağlıklı ve Parlak Uzaması', category: 'beden' },
    { slug: 'dislerinin-bembeyaz-parladigini-ve-saglam-oldugunu-gormek', title: 'Rüyada Dişlerinin Bembeyaz Parladığını ve Çok Sağlam Olduğunu Görmek', category: 'beden' },
    { slug: 'ellerinin-yumusacik-oldugunu-ve-gul-koktugunu-hissetmek', title: 'Rüyada Ellerinin Yumuşacık Olduğunu ve Gül Koktuğunu Hissetmek', category: 'beden' },
    { slug: 'gozlerinin-renginin-berrak-ve-parlak-yesile-donmesi', title: 'Rüyada Gözlerinin Renginin Berrak ve Parlak Yeşile Dönmesi', category: 'beden' }
  ]
};
