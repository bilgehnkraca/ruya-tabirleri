...
// Generate exactly 300 distinct items (15 * 20 = 300)
const adjectives = [
  "Görkemli", "Gizemli", "Büyülü", "Karlı", "Yalnız", 
  "Dev", "Minik", "Renkli", "Karanlık", "Işıltılı", 
  "Sessiz", "Çoşkulu", "Yıkık", "Kutsal", "Uçan"
];

const nouns = [
  { name: "Kartal", cat: "hayvanlar" },
  { name: "Aslan", cat: "hayvanlar" },
  { name: "Kurt", cat: "hayvanlar" },
  { name: "Yunus", cat: "hayvanlar" },
  { name: "Ejderha", cat: "hayvanlar" },
  { name: "Nehir", cat: "doga" },
  { name: "Şelale", cat: "doga" },
  { name: "Ada", cat: "doga" },
  { name: "Mağara", cat: "doga" },
  { name: "Şehir", cat: "mekanlar" },
  { name: "Şato", cat: "mekanlar" },
  { name: "Bahçe", cat: "mekanlar" },
  { name: "Köprü", cat: "mekanlar" },
  { name: "Tren", cat: "yolculuk" },
  { name: "Uçak", cat: "yolculuk" },
  { name: "Saat", cat: "nesneler" },
  { name: "Anahtar", cat: "nesneler" },
  { name: "Sandık", cat: "nesneler" },
  { name: "Kutu", cat: "nesneler" },
  { name: "Mektup", cat: "nesneler" }
];
...
const filePath = path.join(symbolsBaseDir, 'batch-300.json');
...
console.log(`Successfully generated ${generatedList.length} new symbols in content/symbols/batch-300.json!`);
