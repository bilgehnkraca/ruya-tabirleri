...
// Generate exactly 98 distinct items
const adjectives = ["Büyük", "Küçük", "Eski", "Yeni", "Kırık", "Parlak", "Siyah"];
const nouns = [
  { name: "Kapı", cat: "nesneler" },
  { name: "Pencere", cat: "nesneler" },
  { name: "Ayna", cat: "nesneler" },
  { name: "Yüzük", cat: "nesneler" },
  { name: "Gemi", cat: "yolculuk" },
  { name: "Yıldız", cat: "doga" },
  { name: "Ağaç", cat: "doga" },
  { name: "Çiçek", cat: "doga" },
  { name: "Elma", cat: "doga" },
  { name: "Deniz", cat: "doga" },
  { name: "Dağ", cat: "doga" },
  { name: "Kuş", cat: "hayvanlar" },
  { name: "Kedi", cat: "hayvanlar" },
  { name: "Köpek", cat: "hayvanlar" }
];
...
const filePath = path.join(symbolsBaseDir, 'batch-98.json');
...
console.log(`Successfully generated ${generatedList.length} new symbols in content/symbols/batch-98.json!`);
