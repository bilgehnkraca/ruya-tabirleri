...
const adjectives = [
  "Sönük", "Yırtık", "Terkedilmiş", "Harabe", "Issız",
  "Kanatlı", "Denizaltı", "Gökkuşağı", "Şeytani", "Meleksi",
  "Çürük", "Zehirli", "Paslı", "Yosunlu", "Camdan",
  "Köpüklü", "Titrek", "Solgun", "Taze", "Kavrulmuş",
  "Erimiş", "Puslu", "Sisli", "Aydınlık", "Pırıltılı"
];

const nouns = [
  { name: "Karınca", cat: "hayvanlar" },
  { name: "Arı", cat: "hayvanlar" },
  { name: "Salyangoz", cat: "hayvanlar" },
  { name: "Tırtıl", cat: "hayvanlar" },
  { name: "Kelebek", cat: "hayvanlar" },
  { name: "Çekirge", cat: "hayvanlar" },
  { name: "Akrep", cat: "hayvanlar" },
  { name: "Örümcek", cat: "hayvanlar" },
  { name: "Karasinek", cat: "hayvanlar" },
  { name: "Sivrisinek", cat: "hayvanlar" },

  { name: "Vaha", cat: "doga" },
  { name: "Sera", cat: "doga" },
  { name: "Orman", cat: "doga" },
  { name: "Çöl", cat: "doga" },
  { name: "Uçurum", cat: "doga" },
  { name: "Tepe", cat: "doga" },
  { name: "Dağ", cat: "doga" },
  { name: "Kanyon", cat: "doga" },
  { name: "Lav", cat: "doga" },
  { name: "Krater", cat: "doga" },

  { name: "Hastane", cat: "mekanlar" },
  { name: "Okul", cat: "mekanlar" },
  { name: "Kütüphane", cat: "mekanlar" },
  { name: "Mezarlık", cat: "mekanlar" },
  { name: "Cami", cat: "mekanlar" },
  { name: "Kilise", cat: "mekanlar" },
  { name: "Türbe", cat: "mekanlar" },
  { name: "Baraka", cat: "mekanlar" },
  { name: "Şato", cat: "mekanlar" },
  { name: "Hapishane", cat: "mekanlar" },

  { name: "Kasa", cat: "nesneler" },
  { name: "Tabanca", cat: "nesneler" },
  { name: "Tüfek", cat: "nesneler" },
  { name: "Kılıç", cat: "nesneler" },
  { name: "Hançer", cat: "nesneler" },
  { name: "Zırh", cat: "nesneler" },
  { name: "Bıçak", cat: "nesneler" },
  { name: "Balta", cat: "nesneler" },
  { name: "Mızrak", cat: "nesneler" },
  { name: "Yay", cat: "nesneler" }
];
...
const filePath = path.join(symbolsBaseDir, 'batch-1000-more.json');
...
console.log(`Successfully generated ${generatedList.length} new symbols in content/symbols/batch-1000-more.json!`);
